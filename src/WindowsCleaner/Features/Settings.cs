...
namespace WindowsCleaner
{
    ...
    public class AppSettings
    {
        ...
        /// <summary>Langue de l'interface (French ou English)</summary>
    ...
    public static class SettingsManager
    {
        ...
        public static AppSettings Load()
        {
            ...
            { 
                Logger.Log(LogLevel.Error, LanguageManager.Get("settings_load_error", ex.Message));
                return new AppSettings(); 
            }
        }
        ...
        public static void Save(AppSettings s)
        {
            try
            {
                ...
                Logger.Log(LogLevel.Debug, LanguageManager.Get("settings_saved"));
            }
            catch (Exception ex)
            {
                Logger.Log(LogLevel.Error, LanguageManager.Get("settings_save_error", ex.Message));
            }
        }
